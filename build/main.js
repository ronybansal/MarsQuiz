...
/***/ function(module, exports, __webpack_require__) {
	...
	var _begin = __webpack_require__(230);
	...
	var _lose = __webpack_require__(234);
	
	var _lose2 = _interopRequireDefault(_lose);
	
	var _win = __webpack_require__(236);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_reactRouter.Redirect, { from: '/', to: '/test' }),
	        _react2.default.createElement(_reactRouter.Route, { path: '/test', component: _test2.default }),
	        _react2.default.createElement(_reactRouter.Route, { path: '/begin', component: _begin2.default }),
	        _react2.default.createElement(_reactRouter.Route, { path: '/quiz', component: _quiz2.default }),
	        _react2.default.createElement(_reactRouter.Route, { path: '/lose', component: _lose2.default }),
	        _react2.default.createElement(_reactRouter.Route, { path: '/win', component: _win2.default })
	      );
	    }
	  }]);
	...
	var Test = function (_React$Component) {
	  ...
	  _createClass(Test, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'button',
	        { className: 'button', onClick: this._loadBegin },
	        'Take Test'
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Begin = function (_React$Component) {
	  ...
	  function Begin(props) {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Begin).call(this, props));
	  }
	
	  _createClass(Begin, [{
	    key: '_runQuiz',
	    value: function _runQuiz() {
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'span',
	            { className: 'buttonupcase', onClick: this._runQuiz },
	            ' Begin Evaluation '
	          )
	        )
	      );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Quiz = function (_React$Component) {
	  ...
	  _createClass(Quiz, [{
	    ...
	    key: '_startClock',
	    value: function _startClock() {
	      this.setState({ starts: true });
	    }
	  }, {
	    key: '_stopClock',
	    value: function _stopClock() {
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_clock2.default, { starts: this.state.starts, seconds: 60 }),
	  ...
	  _createClass(Clock, [{
	    ...
	    value: function _countdown() {
	      ...
	      if (this.state.seconds <= 0) {
	        ...
	        _reactRouter.browserHistory.push('/lose');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Questions = function (_React$Component) {
	  ...
	  _createClass(Questions, [{
	    ...
	    key: '_displaying',
	    value: function _displaying() {
	      if (questions[this.state.question] === undefined && correct === 0) {
	        _reactRouter.browserHistory.push('/lose');
	      } else if (questions[this.state.question] === undefined && correct <= 1) {
	        _reactRouter.browserHistory.push('/lose');
	      } else if (questions[this.state.question] === undefined && correct === questions.length) {
	        _reactRouter.browserHistory.push('/win');
	      }
	    }
	  }, {
	    key: '_isFinished',
	    ...
	    value: function render() {
	      ...
	      var question = questions[this.state.question].question;
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'form',
	              { className: 'user-answers', name: 'quizInput', onSubmit: this._submitted.bind(this) },
	              _react2.default.createElement('input', { type: 'text', ref: 'quizInput' })
	            ),
	            _react2.default.createElement(
	              'button',
	              { className: 'submitbox', onClick: this._submitAnswer.bind(this) },
	              'submit answer'
	            )
	          )
	        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _clockHidden = __webpack_require__(235);
	
	var _clockHidden2 = _interopRequireDefault(_clockHidden);
	...
	var Lose = function (_React$Component) {
	  _inherits(Lose, _React$Component);
	
	  function Lose(props) {
	    _classCallCheck(this, Lose);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Lose).call(this, props));
	    ...
	    value: function render() {
	      if (this.state.started) {
	        return _react2.default.createElement(
	          'div',
	          { className: 'video' },
	          _react2.default.createElement('iframe', { width: '920', height: '615', src: 'https://www.youtube.com/embed/bNNIUbsvIL8?autoplay=1&controls=0', frameborder: '0', allowfullscreen: true }),
	          _react2.default.createElement(_clockHidden2.default, {
	      ...
	      return _react2.default.createElement(
	        'button',
	        { className: 'button', onClick: this._loadQuiz },
	        'Click to Retry'
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ClockHidden = function (_React$Component) {
	  _inherits(ClockHidden, _React$Component);
	
	  function ClockHidden(props) {
	    _classCallCheck(this, ClockHidden);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ClockHidden).call(this, props));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Win = function (_React$Component) {
	  ...
	  function Win(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Win).call(this, props));
	    ...
	    value: function render() {
	      if (this.state.started) {
	        return _react2.default.createElement(
	          'div',
	          { className: 'video' },
	          _react2.default.createElement('iframe', { width: '860', height: '615', src: 'https://www.youtube.com/embed/YI1GLB-byeQ?autoplay=1&controls=0', frameborder: '0', allowfullscreen: true })
	        );
	      }
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "html, body {\n  width: 100vw;\n  height: 100vh;\n  color: white;\n  background: url(http://www.westcoasttrustsestates.com/files/2015/04/I-Stock-Basketball-Court.jpg) no-repeat center;\n  display: flex;\n  align-items: center;\n  justify-content: center; }\n\nbutton {\n  background: transparent;\n  border: 0; }\n\n.button {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  border: 2px solid purple;\n  background: #EDF1F2;\n  padding: 1rem 4rem;\n  color: blue;\n  cursor: pointer;\n  font-weight: bold;\n  font-size: 1rem;\n  text-transform: uppercase;\n  border-radius: 2px;\n  box-shadow: 0 10px 20px rgba(0, 0, 0, 0.3); }\n\n.clock {\n  border: 2px solid grey;\n  border-bottom: 5px solid grey;\n  border-right: 3px solid grey;\n  color: red;\n  font-size: 40px;\n  padding: 10px 20px;\n  background: black;\n  width: 80px;\n  position: absolute;\n  top: 10px;\n  right: 10px; }\n\n.question-area {\n  width: 80%;\n  margin: 0 auto;\n  padding: 2rem;\n  font-size: 1.5rem;\n  background: #EDF1F2;\n  box-shadow: 0 10px 20px rgba(0, 0, 0, 0.1);\n  color: #969696;\n  line-height: 1.25; }\n\ninput {\n  background: #EDF1F2;\n  border: none;\n  width: 100%;\n  height: 2rem;\n  border-bottom: 1px solid black;\n  font-size: 1.5rem;\n  margin: 2rem 0; }\n\n.submitbox {\n  outline: none;\n  border: 2px solid purple;\n  background: #EDF1F2;\n  padding: 1rem 4rem;\n  color: blue;\n  cursor: pointer;\n  font-weight: bold;\n  font-size: 1rem;\n  text-transform: uppercase;\n  border-radius: 2px;\n  box-shadow: 0 10px 20px rgba(0, 0, 0, 0.3); }\n\n.sidebar {\n  display: none; }\n\n.ClockHidden {\n  display: none; }\n", ""]);
